...
// two fingers pointed down-and-out (~45°, the real roadside wave; "keep both
// wheels down, ride safe"). This is the Phosphor `hand-peace` icon (MIT), rotated
// 225° into that arm-out posture and scaled to 0.9 — the rotated artwork's
// bounding box hits the 256 viewBox edge at about 0.91, so this fills as much
// of the box as it can without clipping. It reads as an
// outline while idle, filling in when the reaction is active — mirroring the like
// it replaces.
//
...
export function TwoWheelsDownIcon({
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g transform="translate(128 128) rotate(225) scale(0.9) translate(-128 -128)">
        {filled ? (
